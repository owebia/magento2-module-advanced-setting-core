...
class Config extends AbstractField
{
    ...
    <div class="owb_head">
        <div id="owb_fh_$elementId" class="owb_fs_only">
            <div class="row">
                ...
                <div class="owb_toolbar col-l-4 col-m-6">
                    <a target="_blank" class="icon icon-help" href="{$this->getUrl('owebia_advancedsettingcore/help/display')}" title="{$this->translate('Help')}"><span>{$this->translate('Help')}</span></a>
        ...
        <div class="owb_fs_hidden owb_toolbar">
            ...
            <a target="_blank" class="icon icon-help" href="{$this->getUrl('owebia_advancedsettingcore/help/display')}" title="{$this->translate('Help')}"><span>{$this->translate('Help')}</span></a>
            <!--<a target="_blank" class="icon icon-check" href="{$this->getUrl('owebia_advancedsettingcore/help/test')}" title="{$this->translate('Test')}"><span>{$this->translate('Test')}</span></a>-->
